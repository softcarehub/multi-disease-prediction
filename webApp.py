...
diabetes_model = pickle.load(open("C:\\Users\\mdbar\\Desktop\\multi-disease\\Diabetes_RandomForest_model.sav",'rb'))

heart_disease_model = pickle.load(open("C:\\Users\\mdbar\\Desktop\\multi-disease\\heart_Adaboost_model.sav","rb"))

parkinsons_model = pickle.load(open("C:\\Users\\mdbar\\Desktop\\multi-disease\\parkinsons_Stacking_Ensemble_model.sav","rb"))
